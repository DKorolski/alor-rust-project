...
pub struct RuntimeHealthSnapshot {
    ...
    pub live_guard_blocked_total: u64,
    pub live_guard_allowed_total: u64,
    pub last_live_guard_blocked_ts_utc: Option<i64>,
    pub last_live_guard_blocked_reasons: Vec<String>,
    pub readiness_wait_started_total: u64,
    pub readiness_wait_allowed_total: u64,
    pub readiness_wait_timeout_total: u64,
    pub intent_blocked_state_kept_total: u64,
    pub orphan_trade_total: u64,
    pub last_orphan_trade_ts_utc: Option<i64>,
...
pub struct HybridIntradaySettings {
    ...
    #[serde(default)]
    pub risk_gate_legacy_session_start_time: Option<String>,
    #[serde(default)]
    pub risk_gate_legacy_session_end_time: Option<String>,
    #[serde(default)]
